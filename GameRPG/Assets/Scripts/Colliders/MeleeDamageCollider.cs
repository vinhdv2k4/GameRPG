...
namespace TV
{
    public class MeleeDamageCollider : DamageCollider
    {
        ...
        public float lightAttackModifier_01;
        public float lightAttackModifier_02;
        public float heavyAttackModifier_01;
        public float heavyAttackModifier_02;
        public float chargeAttackModifier_01;
        public float chargeAttackModifier_02;
        ...
        protected override void DamageTarget(CharacterManager damageTarget)
        {
            ...
            switch (characterCasingDamage.characterCombatManager.currentAttackSyle)
            {
                case AttackStyle.lightAttack01:
                    ApplyAttackDamnageModifiers(lightAttackModifier_01, damageEffect);
                    break;
                case AttackStyle.lightAttack02:
                    ApplyAttackDamnageModifiers(lightAttackModifier_02, damageEffect);
                    break;
                case AttackStyle.heavyAttack01:
                    ApplyAttackDamnageModifiers(heavyAttackModifier_01, damageEffect);
                    break;
                    case AttackStyle.heavyAttack02:
                     ApplyAttackDamnageModifiers(heavyAttackModifier_02, damageEffect);
                     break;
                case AttackStyle.chargeAttack01:
                    ApplyAttackDamnageModifiers(chargeAttackModifier_01, damageEffect);
                    break;
                case AttackStyle.chargeAttack02:
                    ApplyAttackDamnageModifiers(chargeAttackModifier_02, damageEffect);
                    break;
                default:
                    break;
            }
